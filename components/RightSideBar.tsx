      ...
      <section className="banks">
        <div className="flex w=full justify-between">
          ...
          <Link href="/" className="flex gap-2">
            <Image src="/icons/plus.svg" width={20} height={20} alt="adicionar conta" />
            <h2 className="text-14 font-semibold text-gray-600">Adicionar Conta</h2>
          </Link>
        </div>
          {banks?.length > 0 && (
